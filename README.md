...
<h3 align="center">AI/ML Enthusiast | BS Artificial Intelligence Student</h3>
...
- ✉️ Reach me at **muhammadjahanzaibazhar@gmail.com**
- 🚀 Currently working on **AI, Machine Learning, and Deep Learning projects using Python**
- 🧠 Currently learning **Artificial Intelligence, Machine Learning, Deep Learning, and advanced Python**
- 👯 Looking to collaborate on **beginner-friendly AI/ML projects**
- 🤝 Looking for help with **Deep Learning and Neural Networks**
...
- **Electricity Bill Prediction System** — built with C++ and Java, applying core OOP concepts to model real-world billing logic
- **Feature Engineering for Machine Learning** — applied feature engineering techniques to prepare data for ML models (Jupyter Notebook)
- **Data Cleaning Project** — cleaned and preprocessed a raw dataset using Python and Pandas
- **Exploratory Data Analysis (EDA) Project** — analyzed a dataset to uncover patterns and insights (Jupyter Notebook)
- **AI Internship Practice (Day 01)** — foundational exercises from a self-driven AI/ML learning track
